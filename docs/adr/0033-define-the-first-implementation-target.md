# Define the first implementation target

The first implementation target is a public analytics product for passenger car
Listings with URL Filters, current and sold ingestion, Search Result Data first,
Raw Listing Data retained in PostgreSQL, explicit normalized analytics columns,
